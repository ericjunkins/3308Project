...
def throttle(x,pi):
        ...
        if(x >=-100 and x<=100):
                ...
                #pulseLen is the signal corresponding to moving the car. This will be
...
def turn(x,pi):
        #turn is the function that control the steering of the RC car
        if (x >=-100 and x <=100):
                pi.wave_tx_stop()
